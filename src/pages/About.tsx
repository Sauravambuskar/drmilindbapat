  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Learn about Dr. Milind Bapat, a senior urologist and andrologist in Pune with over 35 years of experience in urology, andrology, and kidney cancer treatment."
